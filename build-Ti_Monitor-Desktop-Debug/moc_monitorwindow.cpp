...
#include "../Ti_Monitor/monitorwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Monitorwindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(3, 34, 19)
    ...
    "Monitorwindow\0write_on_statusbar\0\0"
...
void Monitorwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->write_on_statusbar(); break;
        case 1: _t->display_sensor_data(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Monitorwindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Monitorwindow.data,
      qt_meta_data_Monitorwindow,  qt_static_metacall, 0, 0}
};
