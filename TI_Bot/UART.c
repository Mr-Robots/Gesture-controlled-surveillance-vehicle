...
void UART5_Init()
{
		...
		UART5_IBRD_R = 520;  // 80,000,000/(16*115,200)) = 43.40278
		UART5_FBRD_R = 53;  //6-bbit fraction, round(0.40278 * 64) = 26
																					// 8 bit word length (no parity bits, one stop bit, FIFOs)
...
void UART_OutStr(char *str,int i)
{
	while(*str)UART_OutChar(*str++,i);
}
